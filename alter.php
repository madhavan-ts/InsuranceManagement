...
.form-signin input[type="password"] {
    ...
    <nav class="navbar navbar-expand-lg  bg-light">
      <div class="container-fluid ">
        ...
        <div class="navbar-collapse collapse" id="navbarNavDropdown" style="">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active"  href="alter.php">Alter</a>
            </li>
            <li class="nav-item">
  ...
  <form class="form"action="" method="post">
    ...
    <button name="submit" class="btn-signin w-100 btn btn-lg btn-primary" type="submit">Delete User</button>
    </form>
</main>
...
$deluser=$_POST['uname'];
$adpass=md5($_POST['psw']);
if ($adpass!=$_SESSION['admin_pass']) {
    $error[]="Invalid Admin Password";
}
else{
  $conn=mysqli_connect('localhost','root','','insurance_management');
    $del="delete from user_table where username='$deluser'";
    $result=mysqli_query($conn,$del);
    header('location:admin_page.php');
    if(!$result){
        $error[]="No Users deleted";
    }
}
}
?>